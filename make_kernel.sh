...
wget -qc https://www.kernel.org/pub/linux/kernel/v2.6/linux-2.6.33.7.tar.xz
echo "Downloading Patch to 2.6.33.7.2-rt30"
wget -qc https://www.kernel.org/pub/linux/kernel/projects/rt/2.6.33/older/patch-2.6.33.7.2-rt30.xz
cd ..
